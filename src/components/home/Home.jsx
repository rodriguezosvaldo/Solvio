...
const Home = () => {
    return (
        <div className='max-sm:flex-col-reverse flex gap-4 w-full h-full overflow-y-auto'>
            ...
            <div className='max-sm:w-full max-sm:h-1/4 max-sm:p-0 flex w-1/2 h-full justify-center items-center p-2 overflow-y-auto animate-blurred-fade-in duration-300'>
                <MainCategories />
            </div>
        </div>
    )
