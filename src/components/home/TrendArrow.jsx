...
const TrendArrow = ({ direction = 'up', color = '#16a34a' }) => (
  <div className={`transition-transform duration-200 ${direction === 'down' ? 'rotate-180' : ''}`}>
    <svg width="99px" 
    height="99px" 
